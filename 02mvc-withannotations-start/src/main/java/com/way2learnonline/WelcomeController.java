...
import org.springframework.web.bind.annotation.RequestParam;
	...
	/*	@RequestMapping(value={"/welcome.htm","/hello.htm"},params={"x=123"})
		public String sayWelcome(@RequestParam(value="uname",required=false)String username,Map<String, Object> model){
			model.put("message", "welcome to "+username);
...
*/
		...
		/*public String sayWelcomeToUser(String name,Model model){
