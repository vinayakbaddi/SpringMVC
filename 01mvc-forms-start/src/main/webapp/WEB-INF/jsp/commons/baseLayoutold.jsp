...
<html lang="en">
	<head>
	    ...
	    <link rel="stylesheet" type="text/css" href="${initParam.resourcePath}/css/courses.css">
	    <link rel="stylesheet" type="text/css" href="${initParam.resourcePath}/css/post-common.css">
		...
		<script type="text/javascript">
			...
			function uploadMachineId(x){
				...
				if(machineId.length!=0){
					xmlhttp.open("GET","${initParam.resourcePath}/../s/updateMachineId.htm?machineId="+machineId+"&courseId="+x.title,true);
		...
		<script type="text/javascript">
			...
			$("#howToAccessVideos").live("click", function() {
				$.fancybox({
					...
					'height' : 325,
					'type' : 'iframe',
					'href' : '${initParam.resourcePath}/../howToAccessVideos.htm?purchaseId='+this.title,
				});
			});
			...
			$("#seeOurAccountDetails").live("click", function() {
				$.fancybox({
					'centerOnScroll' : false,
					'width' : 680,
					'height' : 325,
					'type' : 'iframe',
					'href' : '${initParam.resourcePath}/../seeOurAccountDetails.htm',
				});
			});
			/* $("#trainingCalendar").live("click", function() {
				$.fancybox({
					...
					'height' : 325,
					'type' : 'iframe',
					'href' : '${initParam.resourcePath}/../trainingCalendar.htm',
				});
			}); */
			$("#coursePending").live("click", function() {
				$.fancybox({
					...
					'height' : 325,
					'type' : 'iframe',
					'href' : '${initParam.resourcePath}/../s/coursePending.htm',
				});
			});
			$("#signUpLink").live("click", function() {
				$.fancybox({
					...
					'height' : 300,
					'type' : 'iframe',
					'href' : '${initParam.resourcePath}/../register.htm'
				});
			});
			$("#howItWorks").live("click", function(){
				$.fancybox({
					...
					'height':325,
					'type':'iframe',
					'href':'${initParam.resourcePath}/../howItWorks.htm'
				});
			});
			$("#courseExpired").live("click", function(){
				$.fancybox({
					...
					'height':325,
					'type':'iframe',
					'href':'${initParam.resourcePath}/../courseExpired.htm'
				});
			});
			$("#cartList").live("click", function() {
				$.fancybox({
					...
					'height' : 545,
					'type' : 'iframe',
					'href' : '${initParam.resourcePath}/../viewCart.htm',
					'onClosed':function () {
						window.parent.location.reload();
					}
				});
			...
			$("#noMachineSecretReceived").live("click", function() {
				$.fancybox({
					...
					'height' : 325,
					'type' : 'iframe',
					'href' : '${initParam.resourcePath}/../s/noMachineSecretReceived.htm',
				});
			});
	    	...
	    	function applyCoupon(){
	    		...
	    		xmlhttp.open("GET","${initParam.resourcePath}/../s/applyCouponCode.htm?couponCode="+couponCode,true);
