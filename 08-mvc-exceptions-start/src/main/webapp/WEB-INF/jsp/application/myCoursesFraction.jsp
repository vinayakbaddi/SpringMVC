									...
									<div class="item">
										...
										<div class="item-credits">
											...
											<div class="right">
												...
												<c:if test='${myPurchase.purchaseType=="oneDay"}'>
													<a href="s/purchaseCourse.htm?courseId=${course.courseId}" class="lnk-button lnk-blue purchase-course">Purchase Videos</a>
												</c:if>
												...
												<c:if test='${myPurchase.status=="pending" and myPurchase.onlinePayment}'>
													<a href="s/purchaseCourse.htm?courseId=${course.courseId}" class="lnk-button lnk-blue add-to-cart">Purchase Videos</a>
												</c:if>
												<c:if test='${myPurchase.status=="pending" and !myPurchase.onlinePayment}'>
													<a href="viewIndividualCourse.htm?courseId=${course.courseId}" class="lnk-button lnk-blue add-to-cart">Start Learning</a>
												</c:if>
